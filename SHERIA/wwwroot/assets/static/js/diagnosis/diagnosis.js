            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "diagnosis_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #diagnosis_date').val(json["diagnosis_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-diagnosis").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #diagnosis_date').val(json["diagnosis_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-diagnosis").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'diagnosis_record', id: rec };
...
function GetDiagnosis() {
    $.get('GetRecords', { module: 'diagnosis_record' }, function (data) {
        getData(data);
    });
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-diagnosis").modal("hide").data("bs.modal", null);
...
$("#capture-diagnosis").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
    $('#diagnosis_date').val("");
    $('#remarks').val("");
