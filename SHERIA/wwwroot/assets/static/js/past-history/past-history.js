            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "past_history_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #past_history_date').val(json["past_history_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-past-history").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #past_history_date').val(json["past_history_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-past-history").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'past_history_record', id: rec };
                            console.log(parameters);
                            $.ajax({
                                url: "/PastHistory/Delete",
                                type: "GET",
                                data: parameters,
                                beforeSend: function () {
...
function GetPastHistory() {
    $.get('GetRecords', { module: 'past_history_record' }, function (data) {
        getData(data);
    });
}
...
$('#save').click(function () {
    ...
    var past_history_date = document.getElementById('past_history_date').value;
    var remarks = document.getElementById('remarks').value;

    var parameters = {
        id: id,
        client_id: client_id,
        past_history_date: past_history_date,
        remarks: remarks
    };
    ...
    $.ajax({
        url: "/PastHistory/CreatePastHistory",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-past-history").modal("hide").data("bs.modal", null);
...
$("#capture-past-history").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
    $('#past_history_date').val("");
    $('#remarks').val("");
});

$('#past_history_date').datepicker({
    todayHighlight: true,
    startDate: '',
    //endDate: '0',
    format: 'yyyy-mm-dd',
