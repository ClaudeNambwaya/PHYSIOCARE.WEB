            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "treatment_plan_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #treatment_plan_date').val(json["treatment_plan_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-treatment-plan").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #treatment_plan_date').val(json["treatment_plan_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-treatment-plan").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'treatment_plan_record', id: rec };
                            console.log(parameters);
                            $.ajax({
                                url: "/TreatmentPlan/Delete",
                                type: "GET",
                                data: parameters,
                                beforeSend: function () {
...
function GetTreatmentPlan() {
    $.get('GetRecords', { module: 'treatment_plan_record' }, function (data) {
        getData(data);
    });
}
...
$('#save').click(function () {
    ...
    var treatment_plan_date = document.getElementById('treatment_plan_date').value;
    var remarks = document.getElementById('remarks').value;

    var parameters = {
        id: id,
        client_id: client_id,
        treatment_plan_date: treatment_plan_date,
        remarks: remarks
    };
    ...
    $.ajax({
        url: "/TreatmentPlan/CreateTreatmentPlan",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-treatment-plan").modal("hide").data("bs.modal", null);
...
$("#capture-treatment-plan").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
    $('#treatment_plan_date').val("");
    $('#remarks').val("");
});

$('#treatment_plan_date').datepicker({
    todayHighlight: true,
    startDate: '',
    //endDate: '0',
    format: 'yyyy-mm-dd',
