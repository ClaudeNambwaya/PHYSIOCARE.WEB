            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "evaluation_date", "autoWidth": true, "sDefaultContent": "n/a" },
                        { "data": "next_visit_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #evaluation_date').val(json["evaluation_date"]);
                    $('.modal-body #next_visit_date').val(json["next_visit_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-patient-evaluation").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #next_visit_date').val(json["next_visit_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-patient-evaluation").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'evaluation_record', id: rec };
...
function GetEvaluation() {
    $.get('GetRecords', { module: 'evaluation_record' }, function (data) {
        getData(data);
    });
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-patient-evaluation").modal("hide").data("bs.modal", null);
...
$("#capture-patient-evaluation").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
    $('#evaluation_date').val("");
    $('#next_visit_date').val("");
