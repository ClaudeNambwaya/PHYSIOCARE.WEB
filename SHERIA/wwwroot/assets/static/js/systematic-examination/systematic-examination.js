            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "systematic_examination_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #systematic_examination_date').val(json["systematic_examination_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-systematic-examination").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #systematic_examination_date').val(json["systematic_examination_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-systematic-examination").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'systematic_examination_record', id: rec };
                            console.log(parameters);
                            $.ajax({
                                url: "/SystematicExamination/Delete",
                                type: "GET",
                                data: parameters,
                                beforeSend: function () {
...
function GetSystematicExamination() {
    $.get('GetRecords', { module: 'systematic_examination_record' }, function (data) {
        getData(data);
    });
}
...
$('#save').click(function () {
    ...
    var systematic_examination_date = document.getElementById('systematic_examination_date').value;
    var remarks = document.getElementById('remarks').value;

    var parameters = {
        id: id,
        client_id: client_id,
        systematic_examination_date: systematic_examination_date,
        remarks: remarks
    };
    ...
    $.ajax({
        url: "/SystematicExamination/CreateSystematicExamination",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-systematic-examination").modal("hide").data("bs.modal", null);
...
$("#capture-systematic-examination").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
    $('#systematic_examination_date').val("");
    $('#remarks').val("");
});

$('#systematic_examination_date').datepicker({
    todayHighlight: true,
    startDate: '',
    //endDate: '0',
    format: 'yyyy-mm-dd',
