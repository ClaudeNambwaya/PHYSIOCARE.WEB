            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "investigation_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #investigation_date').val(json["investigation_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-investigation").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #investigation_date').val(json["investigation_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-investigation").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'investigation_record', id: rec };
                            console.log(parameters);
                            $.ajax({
                                url: "/Investigation/Delete",
                                type: "GET",
                                data: parameters,
                                beforeSend: function () {
...
function GetInvestigation() {
    $.get('GetRecords', { module: 'investigation_record' }, function (data) {
        getData(data);
    });
}
...
$('#save').click(function () {
    ...
    var investigation_date = document.getElementById('investigation_date').value;
    ...
    $.ajax({
        url: "/Investigation/CreateInvestigation",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-investigation").modal("hide").data("bs.modal", null);
...
$("#capture-investigation").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
