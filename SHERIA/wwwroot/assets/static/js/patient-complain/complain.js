            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "patient_complain_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #patient_complain_date').val(json["patient_complain_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-patient-complain").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #patient_complain_date').val(json["patient_complain_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-patient-complain").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'patient_complain_record', id: rec };
                            console.log(parameters);
                            $.ajax({
                                url: "/PatientComplain/Delete",
                                type: "GET",
                                data: parameters,
                                beforeSend: function () {
...
function GetPatientComplain() {
    $.get('GetRecords', { module: 'patient_complain_record' }, function (data) {
        getData(data);
    });
}
...
//        $.each(data, function (index, item) {
//            $("#client_id").get(0).options[$("#client_id").get(0).options.length] = new Option(item.first_name, item.id);
//        });
...
$('#save').click(function () {
    ...
    var patient_complain_date = document.getElementById('patient_complain_date').value;
    var remarks = document.getElementById('remarks').value;

    var parameters = {
        id: id,
        client_id: client_id,
        patient_complain_date: patient_complain_date,
        remarks: remarks
    };
    ...
    $.ajax({
        url: "/PatientComplain/CreatePatientComplain",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-patient-history").modal("hide").data("bs.modal", null);
...
$("#capture-patient-history").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
...
$('#patient_complain_date').datepicker({
    todayHighlight: true,
    startDate: '',
    //endDate: '0',
    format: 'yyyy-mm-dd',
