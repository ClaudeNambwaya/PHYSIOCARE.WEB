            ...
            init: function () {
                ...
                var oTable = $('#editabledatatable').dataTable({
                    ...
                    "aoColumns": [
                        ...
                        { "data": "general_observation_date", "autoWidth": true, "sDefaultContent": "n/a" },
                ...
                function viewRow(oTable, nRow) {
                    ...
                    $('.modal-body #general_observation_date').val(json["general_observation_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#view-general-observation").appendTo("body").modal("show");
                }
                ...
                function editRow(oTable, nRow) {
                    ...
                    $('.modal-body #general_observation_date').val(json["general_observation_date"]);
                    $('.modal-body #remarks').val(json["remarks"]);
                    $("#capture-general-observation").appendTo("body").modal("show");
                }
                ...
                $('#editabledatatable').on("click", 'a.delete', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var parameters = { module: 'general_observation_examination_record', id: rec };
                            console.log(parameters);
                            $.ajax({
                                url: "/GeneralObservationExamination/Delete",
                                type: "GET",
                                data: parameters,
                                beforeSend: function () {
                                ...
                                success: function (data) {
                                    ...
                                    GetGeneralObservationExamination();
                                },
...
function GetGeneralObservationExamination() {
    $.get('GetRecords', { module: 'general_observation_examination_record' }, function (data) {
        getData(data);
    });
}
...
$('#save').click(function () {
    ...
    var general_observation_date = document.getElementById('general_observation_date').value;
    var remarks = document.getElementById('remarks').value;

    var parameters = {
        id: id,
        client_id: client_id,
        general_observation_date: general_observation_date,
        remarks: remarks
    };
    ...
    $.ajax({
        url: "/GeneralObservationExamination/CreateGeneralObservationExamination",
        type: "POST",
        data: parameters,
        beforeSend: function () {
            if (!$(a).hasClass("panel-loading")) {
        ...
        success: function (data) {
            ...
            if (data.error_code === '00') {
                ...
                $("#capture-general-observation").modal("hide").data("bs.modal", null);
...
$("#capture-general-observation").on("hidden.bs.modal", function (e) {
    $('#recordid').val("");
    $('#client_id').val("");
    $('#general_observation_date').val("");
    $('#remarks').val("");
});

$('#general_observation_date').datepicker({
    todayHighlight: true,
    startDate: '',
    //endDate: '0',
    format: 'yyyy-mm-dd',
